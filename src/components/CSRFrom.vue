          ...
          ><div class="grid-content">
            ...
            >
              ...
              <el-form-item>
                ...
                <el-button type="primary" v-if="type == 2" @click="submitSSLForm('ruleForm')">提交</el-button>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-card class="box-card tag" shadow="hover">
              ...
              <el-button type="primary" @click=" getPQC_pubkey()" class="but"
                >自动生成</el-button
              >
            </el-card>
          </el-col>
  ...
  methods: {
    ...
    autoGetKey: function () {
      ...
      this.$axios({
        ...
        console.log(response);
        self.pq =response.data["public_key"]; 
